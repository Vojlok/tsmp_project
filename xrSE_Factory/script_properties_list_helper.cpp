...
BOOLValue* CScriptPropertiesListHelper::CreateBOOL(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name)
{
	return		(PHelper().CreateBOOL(*items,key,wrap_value<bool>(object,name)));
}
